...
#define BOOST_TEST_MODULE parse_import_document_base_head1
...
BOOST_AUTO_TEST_CASE (parse_import_document_base_head)
{
    ...
    ::xmlInitParser ();
    {
        ...
        BOOST_CONCEPT_ASSERT ((concept::parser::Head<parser::libxml2::dom::head>));
#endif
        ...
        GNTL_GLOBAL_ALLOC_REQUIRE (head_traits::has_import_document_base (head));
        
        parser::libxml2::dom::import_document_base
          import_base = head_traits::import_document_base (head);
