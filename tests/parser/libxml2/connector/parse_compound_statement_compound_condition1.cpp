...
#define BOOST_TEST_MODULE parse_compound_statement_condition1
...
BOOST_AUTO_TEST_CASE (parse_compound_statement_compound_condition1)
{
    ...
    ::xmlInitParser ();
    {
        ...
        GNTL_GLOBAL_ALLOC_CHECK_EQUAL (causal_connector_traits::identifier (*first_), "causal1");
        {
              ...
              connector_compound_condition_traits;
            {
                ...
                condition_expression_range
                  condition_expressions = connector_compound_condition_traits
                ...
                condition_expression_iterator
                  condition_iterator = boost::begin(condition_expressions);
                ...
                ++condition_iterator;
                {
                    ...
                    GNTL_GLOBAL_ALLOC_CHECK_EQUAL (connector_compound_statement_traits::operator_ (c), "and");
                    GNTL_GLOBAL_ALLOC_CHECK (!connector_compound_statement_traits::has_is_negated (c));

                    typedef connector_compound_statement_traits::condition_expression_range
                      condition_expression_range;
                    condition_expression_range condition_expressions
                      = connector_compound_statement_traits::condition_expression_all
                      (c);

                    GNTL_GLOBAL_ALLOC_REQUIRE_EQUAL (boost::distance(condition_expressions), 1);

                    GNTL_CONCEPT_ASSERT((ConnectorConditionExpression<parser::libxml2::dom
                                         ::compound_statement_expression>));
                    typedef concept::parser::connector_condition_expression_traits
                      <parser::libxml2::dom::compound_statement_expression>
                      compound_statement_expression_traits;
                    {
                      parser::libxml2::dom::compound_statement_expression
                        condition = *boost::begin(condition_expressions);
                      GNTL_GLOBAL_ALLOC_REQUIRE (compound_statement_expression_traits
                                                 ::is_type<parser::libxml2::dom::connector_assessment_statement>
                                                 (condition));
                      parser::libxml2::dom::connector_assessment_statement
                        s = compound_statement_expression_traits
                      ...
                      parser::libxml2::dom::connector_attribute_assessment
                        f = connector_assessment_statement_traits::first (s);
