...
#define BOOST_TEST_MODULE parse_property_media1
...
BOOST_AUTO_TEST_CASE (parse_property_media)
{
    ...
    ::xmlInitParser ();
    {
        ::xmlDocPtr xmldoc = xmlParseDoc(static_cast<const xmlChar*>(static_cast<const void*>(property_media)));
        ...
        typedef concept::parser::property_traits<parser::libxml2::dom::property> property_traits;
        ...
        media_traits::property_range prange = media_traits::property_all (media);
        GNTL_GLOBAL_ALLOC_CHECK_EQUAL (boost::distance(media_traits::property_all (media)), 1u);

        GNTL_GLOBAL_ALLOC_CHECK_EQUAL (property_traits::name(*boost::begin(prange)), "name1");
        GNTL_GLOBAL_ALLOC_REQUIRE (property_traits::has_value(*boost::begin(prange)));
        GNTL_GLOBAL_ALLOC_CHECK_EQUAL (property_traits::value(*boost::begin(prange)), "value1");
    }
    ::xmlCleanupParser ();
