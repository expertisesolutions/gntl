...
#define BOOST_TEST_MODULE parse_one_region_base_head1
...
BOOST_AUTO_TEST_CASE (parse_one_region_base_head)
{
    ...
    ::xmlInitParser ();
    {
        ...
        GNTL_GLOBAL_ALLOC_CHECK_EQUAL (gntl::range::distance (region_bases), 1);
