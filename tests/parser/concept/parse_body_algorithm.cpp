...
#include <gntl/archetype/parser/body.hpp>
  ...
  typedef archetype::parser::media<archetype::parser::area, archetype::parser::property> media_type;
    typedef 
        ...
        , archetype::parser::property, archetype::parser::port
         ...
         , archetype::parser::switch_port, archetype::parser::bind_rule>
      context_type;
    BOOST_CONCEPT_ASSERT ((concept::parser::Body<archetype::parser::body<context_type> >));
}
