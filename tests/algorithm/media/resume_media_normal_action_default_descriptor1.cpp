...
#define BOOST_TEST_MODULE resume_media_normal_action_default_descriptor1
...
BOOST_AUTO_TEST_CASE (resume_media_normal_action_default_descriptor1)
{
    ...
    algorithm::structure::media::resume (gntl::ref (media), descriptor_type(), gntl::ref(document));
