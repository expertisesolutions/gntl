...
#ifndef GNTL_STRUCTURE_NEW_INSTANCE_REUSED_MEDIA_HPP
#define GNTL_STRUCTURE_NEW_INSTANCE_REUSED_MEDIA_HPP
...
struct new_instance_reused_media
{
  Media media;
  ReusedMedia reused_media;

  new_instance_reused_media(Media media, ReusedMedia reused_media)
...
template <typename Media, typename ReusedMedia>
struct media_traits<gntl::structure::new_instance_reused_media<Media, ReusedMedia> >
{
  ...
  typedef gntl::structure::new_instance_reused_media<Media, ReusedMedia> media_type;
  typedef typename structure_media_traits::identifier_type identifier_type;
  typedef typename structure_media_traits::source_type source_type;
  typedef typename structure_media_traits::instance_type instance_type;
  typedef typename structure_media_traits::type_type type_type;
  typedef typename structure_media_traits::interface_type interface_type;
  typedef typename structure_media_traits::string_type string_type;
  typedef typename structure_media_traits::integer_type integer_type;
  typedef typename structure_media_traits::descriptor_type descriptor_type;
  typedef typename structure_media_traits::descriptor_identifier_type descriptor_identifier_type;
  typedef typename structure_media_traits::presentation_type presentation_type;
  typedef typename structure_media_traits::presentation_range presentation_range;
  ...
  typedef typename structure_media_traits::player_type player_type;
  typedef typename structure_media_traits::explicit_duration_type explicit_duration_type;
  typedef typename structure_media_traits::region_type region_type;
  typedef typename structure_media_traits::freeze_type freeze_type;
  typedef typename structure_media_traits::focus_index_type focus_index_type;
  typedef typename structure_media_traits::color_type color_type;
  typedef typename structure_media_traits::width_type width_type;
  typedef typename structure_media_traits::transparency_type transparency_type;
  typedef typename structure_media_traits::transition_type transition_type;

  static bool is_same_instance_refer(media_type const&)
  {
    return false;
  }
  static identifier_type same_instance_referred(media_type const&)
  {
    std::abort ();
  }
  static bool has_property(media_type const& m, interface_type name)
  {
    return structure_media_traits::has_property(m.media, name);
  }
  static void start_set_property(media_type& m, interface_type name, string_type value)
  {
    structure_media_traits::start_set_property(m.media, name, value);
  }
  ...
  {
    structure_media_traits::commit_set_property(m.media, name);
  }
  static property_range property_all(media_type const& m)
  {
    return structure_media_traits::property_all(m.media);
  }
  static property_type get_property(media_type const& m, interface_type const& name)
  {
    return structure_media_traits::get_property(m.media, name);
  }
  static bool has_presentation(media_type const& m, descriptor_type descriptor)
  {
    return structure_media_traits::has_presentation(m.media, descriptor);
  }
  static presentation_type prepare_presentation(media_type const& m
                                                , descriptor_type descriptor)
  {
    return structure_media_traits::prepare_presentation(m.media, descriptor);
  }
  static presentation_type get_presentation(media_type const& m, descriptor_type descriptor)
  {
    return structure_media_traits::get_presentation(m.media, descriptor);
  }
  static presentation_range presentation_all(media_type& m)
  {
    return structure_media_traits::presentation_all(m.media);
  }
  ...
  {
    return structure_media_traits::area_all(m.media);
  }
  static bool has_player (media_type const& m)
  {
    return reused_media_traits::has_player (m.media);
  }
  static player_type player (media_type const& m)
  {
    return reused_media_traits::player (m.media);
  }
  static bool has_explicit_duration (media_type const& m)
  {
    return reused_media_traits::has_explicit_duration (m.media);
  }
  static boost::posix_time::time_duration explicit_duration (media_type const& m)
  {
    return reused_media_traits::explicit_duration (m.media);
  }
  static bool has_region (media_type const& m)
  {
    return reused_media_traits::has_region (m.media);
  }
  static region_type region (media_type const& m)
  {
    return reused_media_traits::region (m.media);
  }
  static bool has_freeze (media_type const& m)
  {
    return reused_media_traits::has_freeze (m.media);
  }
  static bool freeze (media_type const& m)
  {
    return reused_media_traits::freeze (m.media);
  }
  static bool has_move_left (media_type const& m)
  {
    return reused_media_traits::has_move_left (m.media);
  }
  static int move_left (media_type const& m)
  {
    return reused_media_traits::move_left (m.media);
  }
  static bool has_move_right (media_type const& m)
  {
    return reused_media_traits::has_move_right (m.media);
  }
  static int move_right (media_type const& m)
  {
    return reused_media_traits::move_right (m.media);
  }
  static bool has_move_up (media_type const& m)
  {
    return reused_media_traits::has_move_up (m.media);
  }
  static int move_up (media_type const& m)
  {
    return reused_media_traits::move_up (m.media);
  }
  static bool has_move_down (media_type const& m)
  {
    return reused_media_traits::has_move_down (m.media);
  }
  static int move_down (media_type const& m)
  {
    return reused_media_traits::move_down (m.media);
  }
  static bool has_focus_index (media_type const& m)
  {
    return reused_media_traits::has_focus_index (m.media);
  }
  static int focus_index (media_type const& m)
  {
    return reused_media_traits::focus_index (m.media);
  }
  static bool has_focus_border_color (media_type const& m)
  {
    return reused_media_traits::has_focus_border_color (m.media);
  }
  static color_type focus_border_color (media_type const& m)
  {
    return reused_media_traits::focus_border_color (m.media);
  }
  static bool has_focus_border_width (media_type const& m)
  {
    return reused_media_traits::has_focus_border_width (m.media);
  }
  static int focus_border_width (media_type const& m)
  {
    return reused_media_traits::focus_border_width (m.media);
  }
  static bool has_focus_border_transparency (media_type const& m)
  {
    return reused_media_traits::has_focus_border_transparency (m.media);
  }
  static transparency_type focus_border_transparency (media_type const& m)
  {
    return reused_media_traits::focus_border_transparency (m.media);
  }
  static bool has_focus_source (media_type const& m)
  {
    return reused_media_traits::has_focus_source (m.media);
  }
  static source_type focus_source (media_type const& m)
  {
    return reused_media_traits::focus_source (m.media);
  }
  static bool has_focus_selection_source (media_type const& m)
  {
    return reused_media_traits::has_focus_selection_source (m.media);
  }
  static source_type focus_selection_source (media_type const& m)
  {
    return reused_media_traits::focus_selection_source (m.media);
  }
  static bool has_selection_border_color (media_type const& m)
  {
    return reused_media_traits::has_selection_border_color (m.media);
  }
  static color_type selection_border_color (media_type const& m)
  {
    return reused_media_traits::selection_border_color (m.media);
  }
  static bool has_transition_in (media_type const& m)
  {
    return reused_media_traits::has_transition_in (m.media);
  }
  static transition_type transition_in (media_type const& m)
  {
    return reused_media_traits::transition_in (m.media);
  }
  static bool has_transition_out (media_type const& m)
  {
    return reused_media_traits::has_transition_out (m.media);
  }
  static transition_type transition_out (media_type const& m)
  {
    return reused_media_traits::transition_out (m.media);
  }
};
