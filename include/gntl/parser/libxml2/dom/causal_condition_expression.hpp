...
#ifndef GNTL_PARSER_LIBXML2_DOM_CAUSAL_CONDITION_EXPRESSION_HPP
#define GNTL_PARSER_LIBXML2_DOM_CAUSAL_CONDITION_EXPRESSION_HPP
...
struct causal_condition_expression
{
    causal_condition_expression (xml_node node)
        : node (node) {}
    causal_condition_expression() {}
                                             ...
                                             ::causal_condition_expression>
{
  ...
  typedef gntl::parser::libxml2::dom::causal_condition_expression
    causal_condition_expression;
  ...
  static bool is_type_aux(causal_condition_expression c
  ...
  template <typename T>
  static bool is_type(causal_condition_expression c)
  {
    return is_type_aux(c, tag<T>());
  }
  template <typename T>
  static T get(causal_condition_expression c)
  {
    return T(c.node);
  }  
};
