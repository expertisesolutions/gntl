...
#ifndef GNTL_CONCEPT_PARSER_PORT_HPP
#define GNTL_CONCEPT_PARSER_PORT_HPP
...
struct port_traits
{
  typedef boost::mpl::false_ is_port;
};
...
struct Port
{
    typedef port_traits<X> traits;
    BOOST_MPL_ASSERT_RELATION(traits::is_port::value, ==, true);
