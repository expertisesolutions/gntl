...
#ifndef GNTL_CONCEPT_PARSER_IMPORT_BASE_HPP
#define GNTL_CONCEPT_PARSER_IMPORT_BASE_HPP
...
template <typename T>
struct import_base_traits
{
  typedef boost::mpl::false_ is_import_base;
};

#ifndef GNTL_DISABLE_CONCEPTS
template <typename X>
struct ImportBase : boost::CopyConstructible<X>
{
  typedef import_base_traits<X> traits;
  BOOST_MPL_ASSERT_RELATION(traits::is_import_base::value, ==, true);
  typedef typename traits::document_uri_type document_uri_type;
  typedef typename traits::alias_type alias_type;

  BOOST_CONCEPT_USAGE(ImportBase)
  {
