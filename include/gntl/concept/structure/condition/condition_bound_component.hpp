...
#ifndef GNTL_CONCEPT_STRUCTURE_CONDITION_BOUND_COMPONENT_HPP
#define GNTL_CONCEPT_STRUCTURE_CONDITION_BOUND_COMPONENT_HPP
...
template <typename T>
struct condition_bound_component_traits
{
  typedef boost::mpl::false_ is_condition_bound_component;
};

#ifndef GNTL_DISABLE_CONCEPTS
template <typename X>
struct ConditionBoundComponent
{
  typedef condition_bound_component_traits<X> traits;
  BOOST_MPL_ASSERT_RELATION(traits::is_condition_bound_component::value, ==, true);
  ...
  BOOST_CONCEPT_USAGE(ConditionBoundComponent)
  {
    ...
    convertible_to<bool>(traits::state(i));
    traits::reset(i);
    traits::set(i);
  }
