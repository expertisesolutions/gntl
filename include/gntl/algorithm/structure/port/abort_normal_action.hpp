...
#ifndef GNTL_ALGORITHM_STRUCTURE_PORT_ABORT_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_PORT_ABORT_NORMAL_ACTION_HPP

#include <gntl/algorithm/structure/port/abort_action_traits.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/abort_normal_action.hpp"))
            ...
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::port::abort<abort_action_traits>
