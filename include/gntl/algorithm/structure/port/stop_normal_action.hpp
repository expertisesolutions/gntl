...
#ifndef GNTL_ALGORITHM_STRUCTURE_PORT_STOP_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_PORT_STOP_NORMAL_ACTION_HPP

#include <gntl/algorithm/structure/port/stop_action_traits.hpp>
#include <gntl/algorithm/structure/port/stop.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/stop_normal_action.hpp"))
            ...
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::port::stop<stop_action_traits>
