...
#ifndef GNTL_ALGORITHM_STRUCTURE_PORT_START_IPP
#define GNTL_ALGORITHM_STRUCTURE_PORT_START_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/start.ipp"))
...
#endif
#else
#define GNTL_ALGORITHM_STRUCTURE_PORT_START_start_lookup_functor \
  BOOST_PP_CAT(start_lookup_functor, BOOST_PP_ITERATION())
#define GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base \
  BOOST_PP_CAT(lookup_functor_base, BOOST_PP_ITERATION())
#define GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base_type    \
  GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base               \
  <Port, Context, ContextLocation, Document BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), A)>

template <typename StartPortTraits, typename Port, typename Context
          , typename ContextLocation, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
struct GNTL_ALGORITHM_STRUCTURE_PORT_START_start_lookup_functor
  : GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base_type
{
  typedef GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base_type base_type;

  GNTL_ALGORITHM_STRUCTURE_PORT_START_start_lookup_functor
  ...
  {
    StartPortTraits::start_port_component(this->port, component, this->context_location
                                          , this->document
...
template <typename StartPortTraits, typename Port, typename Context
          , typename ContextLocation, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
void start (Port port, Context context, ContextLocation context_location
            , Document document
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  ...
  try
  {
    algorithm::structure::component::lookup(port_traits::component(port)
                                            , GNTL_ALGORITHM_STRUCTURE_PORT_START_start_lookup_functor
                                            <StartPortTraits, Port, Context, ContextLocation, Document
                                            BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_ITERATION(), A)>
                                            (port, context, context_location, document
                                             BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_ITERATION(), a))
...
#undef GNTL_ALGORITHM_STRUCTURE_PORT_START_start_lookup_functor
#undef GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base
#undef GNTL_ALGORITHM_STRUCTURE_PORT_START_lookup_functor_base_type
