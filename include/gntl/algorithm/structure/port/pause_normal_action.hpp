...
#ifndef GNTL_ALGORITHM_STRUCTURE_PORT_PAUSE_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_PORT_PAUSE_NORMAL_ACTION_HPP

#include <gntl/algorithm/structure/port/pause_action_traits.hpp>
#include <gntl/algorithm/structure/port/pause.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/pause_normal_action.hpp"))
