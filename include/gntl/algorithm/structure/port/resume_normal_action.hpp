...
#ifndef GNTL_ALGORITHM_STRUCTURE_PORT_RESUME_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_PORT_RESUME_NORMAL_ACTION_HPP

#include <gntl/algorithm/structure/port/resume_action_traits.hpp>
#include <gntl/algorithm/structure/port/resume.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/resume_normal_action.hpp"))
...
#endif
#else
template <typename Port, typename Context, typename Document
            ...
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::port::resume<resume_action_traits>
