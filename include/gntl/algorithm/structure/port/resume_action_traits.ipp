...
#ifndef GNTL_ALGORITHM_PORT_RESUME_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_PORT_RESUME_ACTION_TRAITS_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/resume_action_traits.ipp"))
...
void resume_action_traits::resume_port_component (Port port, Component component, Context context, Document document
                                                BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::component::resume (component, context, descriptor, document
