...
#ifndef GNTL_ALGORITHM_PORT_PAUSE_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_PORT_PAUSE_ACTION_TRAITS_IPP

#include <gntl/algorithm/structure/port/pause_action_traits.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/port/pause_action_traits.ipp"))
...
void pause_action_traits::pause_port_component (Port port, Component component, Context context, Document document
                                                BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::component::pause (component, context, descriptor, document
