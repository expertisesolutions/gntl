...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_RESUME_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_RESUME_NORMAL_ACTION_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/media/resume_normal_action.hpp"))
...
{
  media::resume<resume_action_traits>(m, d, document
