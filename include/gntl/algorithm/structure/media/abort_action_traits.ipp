...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_ABORT_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_ABORT_ACTION_TRAITS_IPP

#include <gntl/algorithm/structure/media/abort_action_traits.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/abort_action_traits.ipp"))
...
void abort_action_traits::abort
  ...
  )
{
  ...
  presentation_traits::abort
    (p BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), a));
