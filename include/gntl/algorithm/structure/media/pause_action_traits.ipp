...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_PAUSE_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_PAUSE_ACTION_TRAITS_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/pause_action_traits.ipp"))
...
void pause_action_traits::pause
  (Media m, Presentation p, Document document
   BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  BOOST_MPL_ASSERT((boost::mpl::or_<boost::is_reference<Document>
                    , boost::is_reference_wrapper<Document> >));
