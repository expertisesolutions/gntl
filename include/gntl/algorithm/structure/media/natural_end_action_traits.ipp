...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/natural_end_action_traits.ipp"))
...
void natural_end_action_traits::natural_end(Media m, Presentation presentation, Document document
