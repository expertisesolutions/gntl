...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_SET_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_SET_ACTION_TRAITS_HPP
...
struct set_action_traits
{
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/set_action_traits.hpp"))
...
static
void set(Media m, Interface interface_, Descriptor descriptor, Value value
...
template <typename Media, typename Interface, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
static
void commit_set(Media m, Interface interface_, Document document
                BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a));
#endif
