...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_ABORT_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_ABORT_ACTION_TRAITS_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/abort_action_traits.hpp"))
