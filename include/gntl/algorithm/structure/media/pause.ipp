...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_PAUSE_IPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_PAUSE_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/media/pause.ipp"))
...
#endif
#else
template <typename PauseMediaTraits, typename Media, typename Descriptor
          , typename Document
    ...
    )
{
    ...
    if(concept::has_presentation(m, result_descriptor))
    {
      ...
      if(presentation_traits::is_occurring (presentation))
      {
        GNTL_CONCEPT_ASSERT((concept::structure::Media<media_type>)); 
        PauseMediaTraits::pause
          (m, presentation, document BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), a));
      }
    }
}
#endif
