...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_START_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_START_NORMAL_ACTION_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/media/start_normal_action.hpp"))
...
{
  media::start<start_action_traits>
    (m, l, interface_, descriptor, document, full, document
