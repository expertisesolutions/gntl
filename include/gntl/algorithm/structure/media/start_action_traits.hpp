...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_START_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_START_ACTION_TRAITS_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/start_action_traits.hpp"))
...
static void start(Media m, Location l, OptionalInterface interface_
                  , Descriptor descriptor, Dimensions dim, Document document
