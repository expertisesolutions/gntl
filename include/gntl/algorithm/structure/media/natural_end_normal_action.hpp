...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_NATURAL_END_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_NATURAL_END_NORMAL_ACTION_HPP

#include <gntl/algorithm/structure/media/natural_end.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/media/natural_end_normal_action.hpp"))
...
{
  media::natural_end<natural_end_action_traits>
