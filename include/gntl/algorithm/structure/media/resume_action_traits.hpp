...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_RESUME_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_RESUME_ACTION_TRAITS_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, GNTL_MAX_ARGS               \
  , "gntl/algorithm/structure/media/resume_action_traits.hpp"))
