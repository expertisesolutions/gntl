...
#ifndef GNTL_ALGORITHM_STRUCTURE_MEDIA_NATURAL_END_HPP
#define GNTL_ALGORITHM_STRUCTURE_MEDIA_NATURAL_END_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/media/natural_end.hpp"))
