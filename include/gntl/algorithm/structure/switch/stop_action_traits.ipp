...
#ifndef GNTL_ALGORITHM_STRUCTURE_SWITCH_STOP_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_SWITCH_STOP_ACTION_TRAITS_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/switch/stop_action_traits.ipp"))
...
void stop_action_traits::stop(Switch switch_, Document document
                              BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  ...
  GNTL_DEBUG_LOG("stop_action_traits::stop" << std::endl)
}
