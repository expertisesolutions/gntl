...
#ifndef GNTL_ALGORITHM_STRUCTURE_SWITCH_ABORT_HPP
#define GNTL_ALGORITHM_STRUCTURE_SWITCH_ABORT_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/switch/abort.hpp"))
