...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_NORMAL_ACTION_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/stop_normal_action.hpp"))
            ...
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::context::stop<stop_action_traits>
