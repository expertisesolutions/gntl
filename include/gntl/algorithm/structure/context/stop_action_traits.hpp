...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_ACTION_TRAITS_HPP
...
struct stop_action_traits
{
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/stop_action_traits.hpp"))
#include BOOST_PP_ITERATE ()
  template <typename Document, typename Context>
  static void register_context_stop_event(Document document, Context context)
  {
    ...
    algorithm::structure::document::register_event(document, context
                                                   , interface_, gntl::transition_enum::stops
...
static void stop_component (Component component, Context context, Descriptor descriptor, Document document
                            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a));

template <typename Port, typename Context, typename Descriptor, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
static void stop_port (Port port, Context context, Descriptor descriptor
