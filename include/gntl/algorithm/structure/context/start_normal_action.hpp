...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_START_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_START_NORMAL_ACTION_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/start_normal_action.hpp"))
...
#endif
#else
template <typename Context, typename Location, typename Descriptor, typename Document
            ...
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::context::start<start_action_traits>
