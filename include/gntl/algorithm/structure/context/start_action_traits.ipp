...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_START_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_START_ACTION_TRAITS_IPP

#include <gntl/algorithm/structure/document/register_event.hpp>
#include <gntl/algorithm/structure/context/start_action_traits.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/start_action_traits.ipp"))
...
template <typename Port, typename Context, typename Location, typename Descriptor
          , typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
void start_action_traits::start (Port port, Context context, Location context_location
                                 ...
                                 BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::port::start
      (port, context, context_location, document, full
    ...
    algorithm::structure::document::register_event (document, context, interface_
