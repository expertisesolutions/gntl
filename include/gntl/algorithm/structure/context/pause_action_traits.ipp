...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_PAUSE_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_PAUSE_ACTION_TRAITS_IPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/pause_action_traits.ipp"))
...
void pause_action_traits::pause_component (Component component, Context context, Descriptor descriptor
                                           , Document document
                                           BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  GNTL_DEBUG_LOG("pauseping component by context" << std::endl)
...
template <typename Port, typename Context, typename Descriptor, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
void pause_action_traits::pause_port (Port port, Context context, Descriptor descriptor
                                      , Document document
                                      BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  typedef typename boost::unwrap_reference<Document>::type document_type;
  ...
  // algorithm::structure::port::pause (port, context, document, full
  //                                    BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), a));
