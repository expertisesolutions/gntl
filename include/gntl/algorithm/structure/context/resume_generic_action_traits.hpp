...
#ifndef GNTL_ALGORITHM_CONTEXT_RESUME_GENERIC_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_CONTEXT_RESUME_GENERIC_ACTION_TRAITS_HPP
...
template <typename ResumeContextTraits>
struct resume_generic_action_traits
{
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/resume_generic_action_traits.hpp"))
#include BOOST_PP_ITERATE ()
  ...
  {
    ResumeContextTraits::register_context_resume_event(document, context);
  }
};
...
{
  ResumeContextTraits::resume_component(component, context, descriptor, document
...
static void action_port (Port port, Context context, Descriptor descriptor
                         ...
                         BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  ResumeContextTraits::resume_port(port, context, descriptor, document
                                   BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), a));
}
#endif
