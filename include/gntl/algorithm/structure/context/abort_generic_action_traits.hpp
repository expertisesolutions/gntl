...
#ifndef GNTL_ALGORITHM_CONTEXT_ABORT_GENERIC_ACTION_TRAITS_HPP
#define GNTL_ALGORITHM_CONTEXT_ABORT_GENERIC_ACTION_TRAITS_HPP
...
template <typename AbortContextTraits>
struct abort_generic_action_traits
{
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/abort_generic_action_traits.hpp"))
#include BOOST_PP_ITERATE ()
  ...
  {
    AbortContextTraits::register_context_abort_event(document, context);
  }
};
...
{
  AbortContextTraits::abort_component(component, context, descriptor, document
