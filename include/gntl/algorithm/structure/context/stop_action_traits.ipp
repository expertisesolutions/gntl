...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_ACTION_TRAITS_IPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_STOP_ACTION_TRAITS_IPP

#include <gntl/algorithm/structure/component/stop.hpp>
#include <gntl/algorithm/structure/context/stop_action_traits.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/stop_action_traits.ipp"))
...
void stop_action_traits::stop_component (Component component, Context context, Descriptor descriptor
                                         , Document document
                                         BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  GNTL_DEBUG_LOG("stopping component by context" << std::endl)
...
template <typename Port, typename Context, typename Descriptor, typename Document
          BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), typename A)>
void stop_action_traits::stop_port (Port port, Context context, Descriptor descriptor
                                    , Document document
                                    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
  typedef typename boost::unwrap_reference<Document>::type document_type;
  ...
  // algorithm::structure::port::stop (port, context, document, full
  //                                    BOOST_PP_ENUM_TRAILING_PARAMS (BOOST_PP_ITERATION (), a));
