...
#ifndef GNTL_ALGORITHM_STRUCTURE_CONTEXT_ABORT_NORMAL_ACTION_HPP
#define GNTL_ALGORITHM_STRUCTURE_CONTEXT_ABORT_NORMAL_ACTION_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/context/abort_normal_action.hpp"))
...
void abort (Context context, Descriptor descriptor
            , Document document
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS (BOOST_PP_ITERATION (), A, a))
{
    ...
    algorithm::structure::context::abort<abort_action_traits>
