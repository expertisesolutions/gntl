...
#ifndef GNTL_ALGORITHM_STRUCTURE_COMPONENT_START_HPP
#define GNTL_ALGORITHM_STRUCTURE_COMPONENT_START_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (GNTL_MAX_ARGS), "gntl/algorithm/structure/component/start.hpp"))
